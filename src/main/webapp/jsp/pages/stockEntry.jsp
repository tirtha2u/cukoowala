<div class="col-sm-8 text-left" style="padding-top:15px"> 
   	<div class="panel panel-primary">
	  	<div class="panel-heading" style="background-color:#264d73"><b>Stock Entry</b></div>
	  	<div class="panel-body">		  	
			...
			<div class="row">
			  	...
			  	<!-- <div class="panel-heading">Item Details</div> -->
					<div class="panel-body">
						<div class="row">
							 ...
							 <div class="form-group col-sm-6">
							   <label class="control-label col-sm-4" for="unitOfMeasure">Unit-Of-Measure:</label>
							   <div class="col-sm-8">
							   		<input  type="text" id="unitOfMeasure" class="form-control" placeholder="Enter Unit Of Measure"  />
							   </div>
							 </div>	
					    </div>
					    ...
					    <div class="row">
							 <div class="form-group col-sm-6">
							   <label class="control-label col-sm-4" for="email">Vendor:</label>
							   <div class="col-sm-8">
							 ...
							 <div class="form-group col-sm-6">
							   <label class="control-label col-sm-4" for="stockPoint">Stock Point:</label>
							   <div class="col-sm-8">
							   		<select class="form-control" id="stockPoint">
									  <option>StockPoint1</option>
									  <option>StockPoint1</option>
									  <option>StockPoint1</option>
									  <option>StockPoint1</option>
									</select>
			  ...
			  <div class="row" style="background-color:lavenderblush;margin-left:0px;margin-right:0px"">
			   ...
			   <div class="row" style="background-color:lavender;margin-left:0px;margin-right:0px"">
				  <div class="col-sm-2"><a href="#">Nor-Floxacine</a></div>
				  <div class="col-sm-2">Bobber Babes</div>
				  <div class="col-sm-2">KG</div>
				  <div class="col-sm-2">100</div>
				  <div class="col-sm-2">10</div>
				  <div class="col-sm-2">Godown</div>
