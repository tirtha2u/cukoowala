				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="row">
							...
							<div class="form-group col-sm-6">
								<label class="control-label col-sm-4" for="customerCode">Customer
									Code:</label>
								<div class="col-sm-8">
						...
						<div class="row">
							...
							<div class="form-group col-sm-6">
								<label class="control-label col-sm-4" for="type">Customer
									Type:</label>
								<div class="col-sm-8">
							...
							<div class="form-group col-sm-6">
								<label class="control-label col-sm-4" for="address">Address
									: </label>
								<div class="col-sm-8">
						...
						<div class="row">
							<div class="form-group col-sm-6">
								<label class="control-label col-sm-4" for="ContactNumber">Contact
									Number : </label>
								<div class="col-sm-8">
							...
							<div class="form-group col-sm-6">
								<label class="control-label col-sm-4" for="optForSMS">Opt
									for SMS : </label>
								<div class="col-sm-2">
									<input type="checkbox" id="optForSMS" class="form-control" style="width:20px;height:20px" />
								</div>
							</div>

						</div>
						<button type="button" class="btn btn-info pull-right">Add
							To Grid</button>
					</div>
